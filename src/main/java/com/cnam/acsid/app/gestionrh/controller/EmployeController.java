...
public class EmployeController {
    ...
    @RequestMapping(value="/employe/listerComptes", method = RequestMethod.GET)
    public ModelAndView listerComptes(){
        ...
        modelAndView.setViewName("employe/liste-comptes.html");
        return modelAndView;
    }

    @RequestMapping(value="/employe/annulerConge", method = RequestMethod.GET)
    public String annulerConges(@RequestParam("id") String id){
        ModelAndView modelAndView = new ModelAndView();
        Conge conge = congeRepository.findById(Long.parseLong(id)).get();
        conge.setStatut("ANNULE");
        congeRepository.save(conge);

        return "redirect:/employe/listerConges";
    }

    @RequestMapping(value="/employe/listerConges", method = RequestMethod.GET)
    public ModelAndView listerConges(){
        ...
        for(Conge conge: user.getConges()){
            CongeForm congeForm = convertCongeToForm(conge, user);
            congesForm.add(congeForm);
        }
        modelAndView.addObject("types", typeCongeRepository.findAll());
        modelAndView.addObject("conge", new Conge());
        modelAndView.addObject("userLoggedIn", user);
        modelAndView.addObject("conges", congesForm);
        modelAndView.setViewName("employe/liste-conges.html");
        return modelAndView;
    }


    @RequestMapping(value="/employe/delete", method = RequestMethod.GET)
    public String delete(@RequestParam("id") String id){
        ...
        modelAndView.addObject("userName", "Bienvenue " + user.getName() + " " + user.getLastName() + " (" + user.getEmail() + ")");
        modelAndView.addObject("users", users);
        return "redirect:/employe/listerComptes";
    }

    @RequestMapping(value="/employe/supprimerDiplome", method = RequestMethod.GET)
    public String deleteDiplome(@RequestParam("id") String id, @RequestParam("userId") String userId){
        ...
        modelAndView.setViewName("employe/liste-comptes.html");
        return "redirect:/employe/details?id=" + userId;
    }

    @RequestMapping(value="/employe/ajouterConge", method = RequestMethod.POST)
    public String ajouterConge(Conge conge){
        ModelAndView modelAndView = new ModelAndView();
    ...
    @RequestMapping(value="/employe/ajouterDiplome", method = RequestMethod.POST)
    public String ajouterDiplome(DiplomeForm diplomeForm){
        ...
        modelAndView.setViewName("employe/liste-comptes.html");
        return "redirect:/employe/details?id=" + diplomeForm.getUserId();
    }

    @RequestMapping(value="/employe/supprimerFormation", method = RequestMethod.GET)
    ...
    @RequestMapping(value="/employe/supprimerCompetence", method = RequestMethod.GET)
    ...
    @RequestMapping(value="/employe/ajouterCompetence", method = RequestMethod.POST)
    public String ajouterCompetence(CompetenceForm competenceForm){
        ...
        modelAndView.setViewName("employe/liste-comptes.html");
        return "redirect:/employe/details?id=" + competenceForm.getUserId();
    }

    @RequestMapping(value="/employe/ajouterFormation", method = RequestMethod.POST)
    public String ajouterFormation(FormationForm formationForm){
        ...
        modelAndView.setViewName("employe/liste-comptes.html");
        return "redirect:/employe/details?id=" + formationForm.getUserId();
    }

    @RequestMapping(value="/employe/ajouterContrat", method = RequestMethod.POST)
    public String ajouterContrat(ContratForm contratForm){
        ...
        return "redirect:/employe/details?id=" + contratForm.getUserId();
    }

    @RequestMapping(value="/employe/modifierContrat", method = RequestMethod.POST)
    ...
    @RequestMapping(value="/employe/details", method = RequestMethod.GET)
    public ModelAndView detail(@RequestParam("id") String id){
        ...
        modelAndView.setViewName("employe/details-compte.html");

        return modelAndView;
    }

    @RequestMapping(value="/employe/ajouterCompte", method = RequestMethod.GET)
    public ModelAndView afficherCreationUser(@ModelAttribute("errors") String errors, @ModelAttribute("userForm") UserForm userForm){
        ...
        modelAndView.setViewName("/employe/ajouter-compte.html");
        return modelAndView;
    }

    @RequestMapping(value = "/employe/ajouterCompte", method = RequestMethod.POST)
    public ModelAndView creerNouveauUtilisateur(UserForm user, RedirectAttributes redirectAttributes) {
        ...
        if(!errors.isEmpty()){
            ...
            return new ModelAndView("redirect:/employe/ajouterCompte");
        }
        ...
        if (userExists != null || !errors.isEmpty()) {
            ...
            return new ModelAndView("redirect:/employe/listerComptes");

        }
    }

    @RequestMapping(value="/employe/modifierCompte", method = RequestMethod.GET)
    public ModelAndView afficherModificationUser(@RequestParam("id") String id, @ModelAttribute("errors") String errors){
        ...
        modelAndView.addObject("roles", getNonAdminRoles());
        modelAndView.addObject("sexes", sexeRepository.findAll());
        modelAndView.setViewName("/employe/modifier-compte.html");
        return modelAndView;
    }

    @RequestMapping(value = "/employe/modifierCompte", method = RequestMethod.POST)
    public ModelAndView modifierUtilisateur(@Valid UserForm user, RedirectAttributes redirectAttributes) {
        ...
        if(!errors.isEmpty()){
            redirectAttributes.addFlashAttribute("errors", errors);
            redirectAttributes.addFlashAttribute("userForm", user);
            return new ModelAndView("redirect:/employe/modifierCompte?id=" + user.getId());
        }
        User userExists = userService.findUserByEmail(user.getEmail());
        ...
        if (userExists == null) {
            ...
            modelAndView.addObject("successMessage", "User has been registered successfully");
            modelAndView.addObject("user", new User());
            return new ModelAndView("redirect:/employe/home");

        }
    }


    @RequestMapping(value="/employe/modifierMonCompte", method = RequestMethod.GET)
    public ModelAndView afficherModificationMonCompte(){
        ...
        modelAndView.addObject("user", userForm);
        modelAndView.addObject("sexes", sexeRepository.findAll());
        modelAndView.setViewName("/employe/modifier-moncompte.html");
        return modelAndView;
    }

    @RequestMapping(value = "/employe/modifierMonCompte", method = RequestMethod.POST)
    public ModelAndView modifierMonCompte(@Valid UserForm user, RedirectAttributes redirectAttributes) {
        ...
        if(!errors.isEmpty()){
            redirectAttributes.addFlashAttribute("errors", errors);
            redirectAttributes.addFlashAttribute("userForm", user);
            return new ModelAndView("redirect:/employe/modifierMonCompte");
        }
        User userExists = userService.findUserByEmail(user.getEmail());
    ...
    private Contrat convertContratToEntity(ContratForm contratForm){
        ...
        if(contratForm.getContratId() != null && !contratForm.getContratId().isEmpty() && Integer.parseInt(contratForm.getContratId()) > 0){
